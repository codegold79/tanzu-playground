module github.com/codegold79/tanzu-playground/basic_capability

go 1.17

replace sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.0.1

require github.com/vmware-tanzu/tanzu-framework v0.17.0
